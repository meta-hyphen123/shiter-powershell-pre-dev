...
\033[1;32m   .S    S.    .S_SSSs      sSSs   .S    S.    .S_sSSs     .S   .S S.   
  .SS    SS.  .SS~SSSSS    d%%SP  .SS    SS.  .SS~YS%%b   .SS  .SS SS.  
  S%S    S%S  S%S   SSSS  d%S'    S%S    S&S  S%S   `S%b  S%S  S%S S%S  
  S%S    S%S  S%S    S%S  S%S     S%S    d*S  S%S    S%S       S%S S%S  
  S%S SSSS%S  S%S SSSS%S  S&S     S&S   .S*S  S%S    S&S  S&S  S%S S%S  
  S&S  SSS&S  S&S  SSS%S  S&S     S&S_sdSSS   S&S    S&S  S&S   SS SS   
  S&S    S&S  S&S    S&S  S&S     S&S~YSSY%b  S&S    S&S  S&S    S_S    
  S&S    S&S  S&S    S&S  S&S     S&S    `S%  S&S    S&S  S&S   SS~SS   
  S*S    S*S  S*S    S&S  S*b     S*S     S%  S*S    S*S  S*S  S*S S*S  
  S*S    S*S  S*S    S*S  S*S.    S*S     S&  S*S    S*S  S*S  S*S S*S  
  S*S    S*S  S*S    S*S   SSSbs  S*S     S&  S*S    S*S  S*S  S*S S*S  
  SSS    S*S  SSS    S*S    YSSP  S*S     SS  S*S    SSS  S*S  S*S S*S  
         SP          SP           SP          SP          SP   SP       
         Y           Y            Y           Y           Y    Y \033[1;m
	   
\033[1;31m ~: 300+ Hacking Tools For Linux Distro by\033[1;m \033[1;32mMr. SAGE\033[1;m \033[33m(@thehackingsage) :~\033[1;m

\033[1;31m [!] This Tool Must Run As Root !!!\033[1;m
		''')
		def inicio1():
			while True:
				print ('''
\033[1;36m**********************************
       HACKNIX by Mr. SAGE
**********************************
1) Add Repositories & Update
2) Install Hacking Tools
3) Install Classicmenu Indicator
4) Install Hacking Tools Menu
5) Help
**********************************\033[0m
			''')

				opcion0 = input("\033[1;36mhacknix > \033[1;m")
			
				while opcion0 == "1":
					print ('''
1) Add Hacking Tools Repositories
2) Update Your System
3) Remove All Hacking Tools Repositories
4) View The Contents Of "sources.list" File
					...
					if repo == "1":
						...
						cmd2 = os.system("echo '# Kali Linux Repositories | Added by Mr. SAGE\ndeb http://http.kali.org/kali kali-rolling main contrib non-free' >> /etc/apt/sources.list")
					elif repo == "2":
						...
						delete_list = ["# Kali Linux Repositories | Added by Mr. SAGE\n", "deb http://http.kali.org/kali kali-rolling main contrib non-free\n"]
						fin = open(infile)
...
''')
					...
					repo = input("\033[1;32mDo You Want To Install Hacking Tool Menu ? [y/n]> \033[1;m")
					if repo == "y":
						cmd1 = os.system("apt-get install kali-menu")
				elif opcion0 == "5":
					print (''' 
\033[1;36m********** +Command & Keys+ **********\033[1;m

\033[1;32mback\033[1;m 	\033[1;33mGo back\033[1;m

\033[1;32mgohome\033[1;m	\033[1;33mGo to the main menu\033[1;m

\033[1;32mCTRL+C\033[1;m	\033[1;33mShutdown Hacknix\033[1;m

\033[1;36m**************************************\033[1;m

This Tool Is Build By \033[1;31mMr. SAGE\033[1;m \033[33m(@thehackingsage)\033[1;m

\033[33mTwitter    : https://twitter.com/thehackingsage\033[1;m
\033[33mInstagram  : https://instagram.com/thehackingsage\033[1;m
\033[33mGitHub     : https://github.com/thehackingsage\033[1;m
...
0) Install All Tools
			 ...
			 ''')
						print ("\033[1;32mSelect A Category or Press (0) to Install All Hacking Tools .\n\033[1;m")

						opcion1 = input("\033[1;36mhacknix > \033[1;m")
						if opcion1 == "back":
							inicio1()
						elif opcion1 == "gohome":
							inicio1()
...
0) Install all Information Gathering tools
						...
						''')
							...
							opcion2 = input("\033[1;36mhacknix > \033[1;m")
							if opcion2 == "1":
...
1) Hacktronian
2) Fluxion by Mr. SAGE
3) Ducky for Arduino
4) AnonSurf by Mr SAGE
				''')
							print ("\033[1;32mInsert The Number Of The Tool To Install It .\n\033[1;m")
							opcion2 = input("\033[1;36mhacknix > \033[1;m")
							if opcion2 == "1":
								cmd = os.system("git clone https://github.com/thehackingsage/hacktronian.git && cd hacktronian && chmod +x install.sh && ./install.sh")
								print (" ")
							if opcion2 == "2":
								cmd = os.system("git clone https://github.com/thehackingsage/fluxion.git && cd fluxion && cd install && chmod +x install.sh && ./install.sh")
								print (" ")
							if opcion2 == "3":
								cmd = os.system("git clone https://github.com/thehackingsage/ducky4arduino.git && cd ducky4arduino && firefox https://thehackingsage.github.io/ducky4arduino/")
								print (" ")
							if opcion2 == "4":
								cmd = os.system("git clone https://github.com/thehackingsage/anonsurf.git && cd anonsurf && chmod +x install.sh && ./install.sh")
								print (" ")
							elif opcion2 == "back":
								inicio()
							elif opcion2 == "gohome":
		...
		print ("\033[1;31m [!] Hacknix Shutting Down !!! Goodbye... :)\033[0m")
	except Exception:
